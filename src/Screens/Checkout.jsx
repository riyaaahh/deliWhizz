...
const Checkout = () => {
  return (
    <>
      ...
      <div className="flex flex-wrap justify-center border border-dashed border-red-500 bg-red-100 px-4 py-6">
      ...
      <div className="space-x-4 flex flex-wrap justify-center">
        <div className="rounded-md border mt-10  hover:border-red-500">
          ...
          <button className="text-xl font-bold mr-12">Cash On Delivery</button>
          <input
            className="m-4 w-5 h-5 checked:bg-red-500 checked:border-transparent"
            type="radio"
            name="payment"
      ...
      <div className="flex justify-center absolute bottom-1 w-full">
        <div className="bg-red-500 rounded-lg mb-4">
          <button className="m-4 ml-24 mr-24 text-xl font-bold text-white">
            Place your Order
          </button>
        </div>
      </div>
