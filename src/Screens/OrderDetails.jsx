...
const OrderDetails = () => {
  return (
    <>
      <div className="m-6">
        <div className="rounded-xl px-4 py-2 p-4 mt-4 flex">
        ...
        <div className="rounded-xl px-4 py-2 p-4 mt-4 mb-6 m-4 flex">
          <div>
            <span className="text-xl font-bold">Order Status</span>
          </div>
        </div>
        <div className="rounded-xl border px-4 py-2 p-4 mt-4 mb-6 m-6 flex justify-between items-center">
        ...
        <div className="rounded-xl border px-4 py-2 p-4 mt-4 mb-6 m-6">
          <div class="flex mb-4 px-4 py-2 p-4 mt-4 mb-6 m-6">
            <div class="w-1/3">
        ...
        <div className="rounded-xl border px-4 py-2 p-4 mt-4 mb-6 m-6">
          <div>
            <i className="fa fa-location text-2xl p-3"></i>
        ...
        <div className="rounded-xl border px-4 py-2 p-4 mt-4 mb-6 m-6">
          ...
          <span className="text-md text-xl m-4 font-bold">Free Shipping</span>
        </div>
        <div className="rounded-xl px-4 py-2 p-4 mt-4 mb-6 m-4 flex">
          <div>
        ...
        <div className="rounded-xl border px-4 py-2 p-4 mt-4 mb-6 m-6">
          ...
          <span className="text-md text-xl m-4 font-bold">Credit Card</span>
        </div>
