  ...
  return (
    <>
      ...
      backgroundPosition: 'center',
          ...
          <button className="bg-red-200 border rounded-full px-4 py-2 mr-4 flex items-center">
            <i className="fa fa-shopping-bag text-gray-500 px-4 py-2"></i>
          </button>
        </div>
        ...
        <div className="overflow-x-auto overflow-y-hidden m-5">
          <div className="row flex space-x-4">
            <button className="ml-8 font-bold text-2xl"> Sizes: </button>
            {sizes.map((item, index) => (
              <button
                ...
                } hover:bg-red-700 rounded p-3 w-full border rounded-lg`}
              >
                <strong>
        ...
        <div className="space-x-4 flex flex-wrap justify-center">
          <div className="bg-grey-300 rounded-lg mt-8">
            <button className="m-8 text-xl">
              <i className="fa fa-minus"></i>
            </button>
            <button className="m-8 text-xl"> 1</button>
            <button className="m-8 text-xl">
              <i className="fa fa-plus text-red-700"></i>
            </button>
          </div>
          <div className="bg-red-500 rounded-lg mt-8">
            <button className="m-8 text-xl font-bold text-white">
              Add to cart
            </button>
            <button className="m-8 text-xl font-bold text-white">$15.99</button>
          </div>
        </div>
        <div className="flex justify-center items-center h-full mt-6">
          <div className="bg-black h-3 w-1/4 rounded-full"></div>
        </div>
      </div>
    </>
  );
